...
public class FlightPlain {
    ...
    public FlightPlain(String destination, String departure, String dateDeparture, String timeDeparture, String nowArriving, int idSapr, int idNote, int idDevice, String pilotLicense) {
    ...
    public String toString() {
        return "FlightPlain{" + "destination=" + destination + ", departure=" + departure + ", dateDeparture=" + dateDeparture + ", timeDeparture=" + timeDeparture + ", nowArriving=" + nowArriving + ", idSapr=" + idSapr + ", idNote=" + idNote + ", idDevice=" + idDevice + ", pilotLicense=" + pilotLicense + '}';
    }
